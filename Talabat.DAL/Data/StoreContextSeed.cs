    ...
    public class StoreContextSeed
    {
        public static async Task SeedAsync(StoreDBContext context, ILoggerFactory loggerFactory)
        {
            try
            {
                ...
                {
                    var barandData = File.ReadAllText("../Talabat.DAL/Data/SeedData/brands.json");
                    var brands = JsonSerializer.Deserialize<List<ProductBrand>>(barandData);
                ...
                {
                    var deliveryMethodData = File.ReadAllText("../Talabat.DAL/Data/SeedData/delivery.json");
